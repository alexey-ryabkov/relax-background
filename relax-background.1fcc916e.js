...
var _visualizer = require("./components/visualizer");
...
var _eventEmitter = require("./app/EventEmitter");
var _eventEmitterDefault = parcelHelpers.interopDefault(_eventEmitter);
var _utils = require("./app/utils");
const eventBus = new (0, _eventEmitterDefault.default)();
(0, _playerDefault.default).environment = eventBus;
let currentTrack = (0, _utils.getTrack)(0);
let nextTrack = currentTrack;
const logoAccent = /** @type HTMLElement */ document.querySelector('.page__logo-part_accent');
logoAccent.style.color = currentTrack?.theme?.color ?? 'inherit';
logoAccent.classList.remove('no-animation');
(0, _playerDefault.default).on('playing:toggle', ({ trackNum, flag })=>{
    (0, _visualizerDefault.default).togglePlaying(flag);
    (0, _statusDefault.default).togglePlaying(flag);
});
(0, _playerDefault.default).on('change-record:init', ({ trackNum })=>{
    if (nextTrack = (0, _utils.getTrack)(trackNum)) {
        (0, _statusDefault.default).track = nextTrack;
        (0, _statusDefault.default).toggleLoading(true);
        const { video } = (0, _utils.getTrack)(trackNum) ?? {};
        // console.log('change to track num', trackNum, getTrack(trackNum));
        if (video) {
            (0, _visualizerDefault.default).once('footage-loaded', ()=>eventBus.trigger('ready2change-record'));
            (0, _visualizerDefault.default).nextFootage = video;
        }
    }
});
(0, _playerDefault.default).on('change-record:start-animation', ()=>{
    (0, _visualizerDefault.default).replaceFootage();
    const themeColor = nextTrack?.theme?.color ?? '';
    logoAccent.style.color = themeColor || 'inherit';
    document.querySelector('meta[name="theme-color"]')?.setAttribute('content', themeColor);
});
(0, _playerDefault.default).on('change-record:start', ()=>{
    (0, _statusDefault.default).toggleLoading(false); // by this time both audio n video loaded
});
(0, _playerDefault.default).on('change-record:end', ()=>{
    currentTrack = nextTrack;
});
(0, _statusDefault.default).track = currentTrack;

},{"./components/player":"dhLX6","./components/visualizer":"8amrD","./components/status":"eFYht","./app/EventEmitter":"fSOyu","./app/utils":"hfueq","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"dhLX6":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _playerScss = require("./player.scss");
var _player = require("./Player");
var _playerDefault = parcelHelpers.interopDefault(_player);
exports.default = new (0, _playerDefault.default)(/** @type HTMLElement */ document.querySelector('.player'));

},{"./player.scss":"kbZZs","./Player":"6lkuz","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"kbZZs":[function() {},{}],"6lkuz":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
var _utils = require("../../app/utils");
class Player extends (0, _componentDefault.default) {
    /** @type Eventful|undefined **/ environment;
    /**
   ...
   */ async togglePlaying(flag, independently = true) {
        ...
        if ((0, _lodash.isUndefined)(flag)) flag = !this.isPlaying();
        ...
        if (independently) {
            ...
            this._toggleCtrl.querySelector('i')?.classList.replace(flag ? 'fa-play' : 'fa-pause', flag ? 'fa-pause' : 'fa-play');
        }
    }
    /**
   ...
   */ async changeRecord(dir, resume) {
        ...
        Promise.all([
            ...
            if (resume) await this.togglePlaying(true);
    ...
    _init() {
        ...
        this._container.addEventListener('click', (event)=>{
            const element = /** @type {HTMLElement|undefined} */ event.target?.closest(`.${this._getElementCls('button')}`);
            if (!element) return;
            if (element === this._toggleCtrl) this.togglePlaying();
            else this.changeRecord(element === this._nextCtrl ? 'next' : 'previous', this.isPlaying());
        });
    }
    /**
   * @param {'previous'|'next'} dir
   */ _replaceCurrentRecordElem(dir) {
        ...
        this._currentRecordElem.classList.remove(this._getElemModificationCls('record', 'settled'));
        this._getRecordElemChange2(dir, currentElem).classList.add(this._getElemModificationCls('record', 'settled'));
    }
    /**
   * @param {'previous'|'next'} dir
   ...
   */ _getRecordElemChange2(dir, currentElem = this._currentRecordElem) {
        let recordElem = /** @type {HTMLElement|undefined} */ currentElem[`${dir}ElementSibling`];
        recordElem ??= /** @type {HTMLElement} */ dir == 'previous' ? (0, _lodash.last)(this._records) : (0, _lodash.first)(this._records);
        return recordElem;
    }
    /**
   ...
   */ _loadTrack(recordElem) {
        ...
        const loading = /** @type Promise<void> */ new Promise((resolve, reject)=>{
   ...
   */ _wait4envReady2changeRecord() {
        return this.environment ? new Promise((resolve)=>{
   ...
   */ async _toggleTonearmAnimation(flag) {
        ...
        return (0, _utils.cssAnimation)(this._tonearm, 'transition');
    }
    /**
   * @param {boolean} flag
   ...
   */ async _toggleRecordEjectedAnimation(flag) {
        ...
        return (0, _utils.cssAnimation)(this._currentRecordElem, 'transition');
    }
    /**
   * @param {'previous'|'next'} dir
   */ _changeRecordAnimation(dir) {
        ...
        const animation = (0, _utils.rotateElement)(this._getElement('playlist'), (dir == 'next' ? -1 : 1) * angle);
   ...
   */ _toggleCtrlsActivity(flag, control) {
        if (control) this._setElemActivity(control, 'button', flag);
        else {
   ...
   */ _defineTrackNum(recordElem = this._currentRecordElem) {
        return (0, _lodash.indexOf)(this._records, recordElem);
    }
    ...
    get _currentVinyl() {
        return /** @type HTMLElement */ this._currentRecordElem.querySelector(`.${this._getElementCls('record-vinyl')}`);
    }
    get _tonearm() {
...
},{"lodash":"LUhzz","../../app/Component":"31XMV","../../app/utils":"hfueq","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"LUhzz":[function(require,module,exports,__globalThis) {
var global = arguments[3];
(function() {
...
},{}],"31XMV":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class Component {
    ...
    /** @type string */ _name;
    _emitter = new (0, _eventEmitterDefault.default)();
    // FIXME oO проще явно прописать методы эмиттера
    /** @type EventHandlerMethod */ // @ts-ignore method initialized in constructor
    on;
    /** @type EventHandlerMethod */ // @ts-ignore method initialized in constructor
    once;
    /** @type EventHandlerMethod */ // @ts-ignore method initialized in constructor
   ...
   */ _setElemActivity(element, elemName, flag) {
        if (element) {
            ...
            element.classList.toggle(this._getElemModificationCls(elemName, 'inactive'), !flag);
            if (element instanceof HTMLButtonElement || element instanceof HTMLInputElement) element.disabled = !flag;
        }
    }
    /**
   * @param {string} name
   ...
   */ _getElements(name, modificator) {
        return Array.from(modificator ? this._container.querySelectorAll(`.${this._getElemModificationCls(name, modificator)}`) : this._container.querySelectorAll(`.${this._getElementCls(name)}`));
    }
    /**
   * @param {string} elemName
   * @returns {string}
   ...
   */ _hasModification(modificator) {
        return this._container.classList.contains(this._getModificationCls(modificator));
    }
    /**
   * @param {string} modificator
   * @returns {string}
   ...
   */ _isElemModificationOf(element, elemName, modificator) {
        return element.classList.contains(this._getElemModificationCls(elemName, modificator));
    }
}
exports.default = Component;

},{"./EventEmitter":"fSOyu","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"fSOyu":[function(require,module,exports,__globalThis) {
/**
 * @implements {Eventful}
 */ var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class EventEmitter {
    /** @type Events */ _events = {};
    /** @type Events */ _onceEvents = {};
    /** @type EventHandlerMethod */ on(event, listener) {
        if (!this._events[event]) this._events[event] = [];
        this._events[event].push(listener);
    // return this;
    }
    /** @type EventHandlerMethod */ once(event, listener) {
        if (!this._events[event]) this._onceEvents[event] = [];
   ...
   * @param {...any} args
   */ trigger(event, ...args) {
        if (this._events[event]) this._events[event].forEach((listener)=>{
            listener(...args);
        });
    ...
    /** @type EventHandlerMethod */ off(event, listener) {
        if (this._events[event]) this._events[event] = this._events[event].filter((l)=>l !== listener);
        if (this._onceEvents[event]) this._onceEvents[event] = this._onceEvents[event].filter((l)=>l !== listener);
    // return this;
    }
}
...
},{}],"hfueq":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
/**
 * @param {number} time
 ...
 */ parcelHelpers.export(exports, "delayer", ()=>delayer);
/**
 * @param {HTMLElement} element
 ...
 * @returns
 */ parcelHelpers.export(exports, "rotateElement", ()=>rotateElement);
/**
 * @param {HTMLElement} element
 * @returns {number}
 */ parcelHelpers.export(exports, "getRotation", ()=>getRotation);
parcelHelpers.export(exports, "cssAnimation", ()=>cssAnimation);
parcelHelpers.export(exports, "getPlaylist", ()=>getPlaylist);
parcelHelpers.export(exports, "getTrack", ()=>getTrack);
parcelHelpers.export(exports, "parseAnimationTime", ()=>parseAnimationTime);
var _lodash = require("lodash");
...
function delayer(time, cb) {
    return new Promise((resolve)=>(0, _lodash.delay)(()=>{
            cb?.();
            resolve();
        }, time));
}
function rotateElement(element, angle, duration, easing = 'ease-in-out') {
    const currentAngle = getRotation(element);
    if (duration) return element.animate([
        {
...
function getRotation(element) {
    ...
    const matrix = transform.split('(')[1].split(')')[0].split(', ').map((item)=>+item);
    const angle = Math.atan2(matrix[1], matrix[0]) * (180 / Math.PI);
    return angle;
}
const cssAnimation = (element, type = 'animation')=>{
    return new Promise((resolve)=>{
        element.addEventListener(`${type}end`, ()=>resolve(), {
            once: true
        });
    });
};
const getPlaylist = ()=>(0, _lodash.flatMap)((0, _lodash.times)(_FAKE_PLAYLIST_MULTIPLIER), ()=>(0, _playlistJsonDefault.default));
const getTrack = (trackNum)=>getPlaylist()[trackNum] ?? null;
const parseAnimationTime = (str)=>{
    if ((0, _lodash.endsWith)(str, 'ms')) return (0, _lodash.toNumber)((0, _lodash.trimEnd)(str, 'ms'));
    if ((0, _lodash.endsWith)(str, 's')) return (0, _lodash.toNumber)((0, _lodash.trimEnd)(str, 's')) * 1000;
    return 0;
};

},{"lodash":"LUhzz","../playlist.json":"dScYo","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"dScYo":[function(require,module,exports,__globalThis) {
module.exports = JSON.parse('[{"title":"Maarten Schellekens - Up from Here","audio":"Maarten Schellekens - Up from Here.mp3","video":"8319438-sd_640_360_25fps.mp4","licence":"\u0422\u0440\u0435\u043A \\"Up from Here\\" \u0437\u0430 \u0430\u0432\u0442\u043E\u0440\u0441\u0442\u0432\u043E\u043C \\"Maarten Schellekens\\" \u0438\u0437\u0434\u0430\u043D \u043F\u043E\u0434 \u043B\u0438\u0446\u0435\u043D\u0437\u0438\u0435\u0439 CC BY 4.0","theme":{"color":"goldenrod"}},{"title":"Maarten Schellekens - Sweet Dreams (Middle-East Remix)","audio":"Maarten Schellekens - Sweet Dreams - Middle-East Remix.mp3","video":"uhd_30fps.mp4","licence":"\u0422\u0440\u0435\u043A \\"Sweet Dreams (Middle-East Remix)\\" \u0437\u0430 \u0430\u0432\u0442\u043E\u0440\u0441\u0442\u0432\u043E\u043C \\"Maarten Schellekens\\" \u0438\u0437\u0434\u0430\u043D \u043F\u043E\u0434 \u043B\u0438\u0446\u0435\u043D\u0437\u0438\u0435\u0439 CC BY 4.0","theme":{"color":"paleTurquoise"}},{"title":"Maarten Schellekens - On a long and winding desert road","audio":"Maarten Schellekens - On a long and winding desert road.mp3","video":"855548-hd_1920_1080_25fps.mp4","licence":"\u0422\u0440\u0435\u043A \\"On a long and winding desert road\\" \u0437\u0430 \u0430\u0432\u0442\u043E\u0440\u0441\u0442\u0432\u043E\u043C \\"Maarten Schellekens\\" \u0438\u0437\u0434\u0430\u043D \u043F\u043E\u0434 \u043B\u0438\u0446\u0435\u043D\u0437\u0438\u0435\u0439 CC BY 4.0","theme":{"color":"plum"}},{"title":"Maarten Schellekens - Ulua Beach","audio":"Maarten Schellekens - Ulua Beach.mp3","video":"856935-hd_1920_1080_24fps.mp4","licence":"\u0422\u0440\u0435\u043A \\"Ulua Beach\\" \u0437\u0430 \u0430\u0432\u0442\u043E\u0440\u0441\u0442\u0432\u043E\u043C \\"Maarten Schellekens\\" \u0438\u0437\u0434\u0430\u043D \u043F\u043E\u0434 \u043B\u0438\u0446\u0435\u043D\u0437\u0438\u0435\u0439 CC BY 4.0","theme":{"color":"YellowGreen"}}]');

},{}],"8amrD":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _visualizerScss = require("./visualizer.scss");
var _visualizer = require("./Visualizer");
var _visualizerDefault = parcelHelpers.interopDefault(_visualizer);
exports.default = new (0, _visualizerDefault.default)(/** @type HTMLElement */ document.querySelector('.visualizer'));

},{"./visualizer.scss":"89vw9","./Visualizer":"c1J1Z","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"89vw9":[function() {},{}],"c1J1Z":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _lodash = require("lodash");
var _component = require("../../app/Component");
var _componentDefault = parcelHelpers.interopDefault(_component);
var _utils = require("../../app/utils");
class Visualizer extends (0, _componentDefault.default) {
    /**
   * @param {HTMLElement} element
   */ constructor(element){
    ...
    get _footage() {
        return /** @type HTMLVideoElement */ this._getElement('footage', 'current');
    }
    get _nextFootage() {
   ...
   * @param {string} src
   */ set nextFootage(src) {
        this._nextFootage.addEventListener('canplay', ()=>this._emit('footage-loaded'), {
            once: true
        });
   ...
   */ async togglePlaying(flag) {
    ...
    async replaceFootage() {
        if (this._nextFootage.src && this._nextFootage.src !== this._footage.src) {
            ...
            const replaceAnimation = Promise.all([
                (0, _utils.cssAnimation)(currentFootage, 'transition'),
                (0, _utils.cssAnimation)(nextFootage, 'transition')
            ]).then(()=>{
    ...
    isPlaying() {
        return !this._footage.paused && !this._footage.ended && this._footage.readyState > 2;
    }
    _init() {
    // nothing to do...
    }
...
},{"lodash":"LUhzz","../../app/Component":"31XMV","../../app/utils":"hfueq","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"eFYht":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _statusScss = require("./status.scss");
var _status = require("./Status");
var _statusDefault = parcelHelpers.interopDefault(_status);
exports.default = new (0, _statusDefault.default)(/** @type HTMLElement */ document.querySelector('.status'));

},{"./status.scss":"89y2O","./Status":"ly2rK","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"89y2O":[function() {},{}],"ly2rK":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _component = require("../../app/Component");
var _componentDefault = parcelHelpers.interopDefault(_component);
class Status extends (0, _componentDefault.default) {
    /**
   * @readonly
   * @protected
   ...
   */ set track(track) {
        ...
        this._titleText.textContent = track ? Status._TRACK_SETTLED_STATUS : Status._DEFAULT_STATUS;
    }
    /**
   * @param {boolean} flag
   */ togglePlaying(flag) {
        if (this._currentTrack) this._titleText.textContent = flag ? Status._TRACK_PLAYING_STATUS : Status._TRACK_LOADED_STATUS;
    }
    /**
   * @param {boolean} flag
   */ toggleLoading(flag) {
        this._title.classList.toggle(this._getElemModificationCls('title-text', 'loading'), flag);
        this._titleText.textContent = flag ? Status._TRACK_LOADING_STATUS : Status._TRACK_LOADED_STATUS;
    }
    _init() {
...
},{"../../app/Component":"31XMV","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}]},["6BDg4","fILKw"], "fILKw", "parcelRequire03af")

//# sourceMappingURL=relax-background.1fcc916e.js.map
